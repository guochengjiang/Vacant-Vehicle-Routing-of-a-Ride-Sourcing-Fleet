"""Original small-network generator, preserved for numerical reproduction.

Legacy topology and time conventions are deliberately unchanged.
This is a synthetic grid, not the standard Sioux Falls benchmark.
"""
import numpy as np
import heapq
